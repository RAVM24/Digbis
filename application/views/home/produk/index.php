<div class="container-fluid pt-5">
  ...
  <tbody>
    ...
    <a href="<?php echo site_url('produk/delete/'.$val->idProduk);?>" onclick="return confirm('Yakin Akan Hapus Data Ini?')"><button type="button" class="btn btn-secondary">Hapus</button></a>
</div>
</td></tr>
<?php $no++; } ?>
