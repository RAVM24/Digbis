            ...
            <div class="col-lg-7 mb-5">
                <div class="contact-form">
                    ...
                    <form name="sentMessage"  method="post" action="<?php echo site_url('main/save_reg');?>">
						...
						<div class="control-group">
                            <input type="text" name="telpon" class="form-control" id="telepon" placeholder="Telpon"
                                required="required" data-validation-required-message="Please enter your telepon number" />
                            <p class="help-block text-danger"></p>
                        </div>
						<div class="control-group">
